...
export const recipeImages: Record<string, string> = {
  ...
  // =================== SAUCES ===================
  'mbongo-tchobi': 'https://upload.wikimedia.org/wikipedia/commons/5/55/Mbongo_tchobi_et_banae_plantin_malx%C3%A9.jpg',
  ...
  'okok-sucre': 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Ikok_mix%C3%A9_et_son_manioc_vapeur.jpg',
  ...
  'sanga': 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Sanga%2C_Plat_camerounais.jpg',
  ...
  'met-de-pistache': 'https://upload.wikimedia.org/wikipedia/commons/a/ad/Mets_de_pistache_pr%C3%AAt_%C3%A0_la_consommation.jpg',
